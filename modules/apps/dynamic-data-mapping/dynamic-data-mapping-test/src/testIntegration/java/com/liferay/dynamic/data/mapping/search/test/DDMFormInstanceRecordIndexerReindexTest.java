...
public class DDMFormInstanceRecordIndexerReindexTest {
	...
	public void testReindexing() throws Exception {
		...
		indexerFixture.searchOnlyOne(searchTerm);

		Document document = indexerFixture.searchOnlyOne(searchTerm);

		indexerFixture.deleteDocument(document);

		indexerFixture.searchNoOne(searchTerm);

		indexerFixture.reindex(ddmFormInstanceRecord.getCompanyId());
	...
	protected void setUpUserIndexerFixture() {
		indexerFixture = new IndexerFixture<>(DDMFormInstanceRecord.class);
	}
	...
	protected IndexerFixture<DDMFormInstanceRecord> indexerFixture;
